...
public class Password extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Boolean cajaAbierta = (Boolean) request.getSession().getAttribute("cajaAbierta");

        if (cajaAbierta) {
            String contraseñaAComprobar = request.getParameter("pass");

            if (contraseñaAComprobar.equals(contraseña)) {
                pass = true;
                request.getSession().setAttribute("passOK",true);
            } else {
